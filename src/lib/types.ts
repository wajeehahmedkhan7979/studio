...
export interface NepraAnswer {
  ...
  // Potentially add question category if known at time of answering
...
// Consider aligning Genkit flow inputs more closely with NepraSessionData or a subset.
export interface QuestionnaireDataForReport {
  questions: string[];
  answers: Record<string, string>; // Genkit flow currently expects string-indexed answers
}
